// LOCVM Matching Engine - Orchestration Service Interfaces
//
 ...
 */
export interface ShortTermMatchService {
  /**
   ...
   *
   * @param jobId - the ID of the newly posted short-term job
   * @returns the ID of the created match run
   */
  runForJob(jobId: string): Promise<string>;
}
 ...
 */
export interface WeeklyDigestService {
  /**
