...
export function toDomain(raw) {
  ...
  return {
    ...
    locumDurations: ensureStringArray(prefs.locumDurations)
      ...
      .filter(/** @returns {d is import("@locvm/types").DurationRange} */ (d) => d !== null),
 ...
 * @param {(address: import("@locvm/types").Address) => Promise<import("@locvm/types").GeoCoordinates | null> | import("@locvm/types").GeoCoordinates | null} geocodeFn
